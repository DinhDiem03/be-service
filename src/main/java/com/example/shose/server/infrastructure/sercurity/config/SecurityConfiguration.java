...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(
                        request -> request.requestMatchers("/login-v2/**" ,"/client/**","/client/voucher/**","/client/bill/**","/cart/**","/admin/poin/**","/cart-detail/**","/admin/promotion","/admin/voucher","/ws/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedOrigin("http://192.168.1.9:3010");
